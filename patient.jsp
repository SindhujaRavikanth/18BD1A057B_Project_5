...
<body>
	<div class="container">
		...
		<input class="form-control form-control-sm" type="text" name="phno" id="phno" style="display:inline-block; width:300px;margin-top:25px;" required>
	...
	<script>
		var websocket=new WebSocket("ws://localhost:8083/MicroProject5/VitalCheckEndPoint");
